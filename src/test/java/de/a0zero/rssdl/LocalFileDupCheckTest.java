...
class LocalFileDupCheckTest {
	...
	void insert() {
		...
		LocalFileDupCheck localFileDupCheck = new LocalFileDupCheck("target/target.properties");
		localFileDupCheck.addEntry("tag:soundcloud,2010:tracks/542456055", "Bla", 172796);
		localFileDupCheck.save("target/target.properties");

		localFileDupCheck = new LocalFileDupCheck("target/target.properties");
